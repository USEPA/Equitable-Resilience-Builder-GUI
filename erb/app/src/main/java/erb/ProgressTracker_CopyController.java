...
public class ProgressTracker_CopyController implements Initializable{
	...
	public ProgressTracker_CopyController(TaskTracker taskTracker, GoalTracker goalTracker) {
...
//		}
	...
	public CheckBox createGoalCheckBox(ERBGoal erbGoal) {		
		...
		checkBox.setMaxWidth(goalsListView.getPrefWidth() - 5);
		//Min
