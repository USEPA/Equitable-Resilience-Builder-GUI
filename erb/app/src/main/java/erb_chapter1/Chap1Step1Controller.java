...
public class Chap1Step1Controller implements Initializable{
	...
	public Chap1Step1Controller(WizardContainerController wizardContainerController) {
...
//		chapter_Handler.addBreadCrumbPanel(contentVBox);
		chapter_Handler.addBreadCrumbPanel(headerHBox, 1);
