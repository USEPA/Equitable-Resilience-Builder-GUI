...
public class Chap3Step4Controller implements Initializable{
	...
	Wizard wizard;
	public Chap3Step4Controller(WizardContainerController wizardContainerController, Wizard wizard) {
